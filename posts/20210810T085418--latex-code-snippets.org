...
:PROPERTIES:
:CUSTOM_ID: code-with-syntax-highlighting
:END:
...
:PROPERTIES:
:CUSTOM_ID: sans-serif-helvetica
:END:
*preamble*
...
:PROPERTIES:
:CUSTOM_ID: table-layout-with-more-space
:END:
...
:PROPERTIES:
:CUSTOM_ID: increase-linespacing
:END:
#+begin_src latex
\linespread{1.5}
#+end_src
